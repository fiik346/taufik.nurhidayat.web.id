...
export default function AboutMe() {
	return (
		<div className="flex flex-wrap lg:flex-nowrap lg:gap-8 items-center">
			<div className="w-full lg:w-1/3 p-4 md:p-8 flex items-center justify-center lg:order-last">
				<div>
					<Image src={profilePicture} alt="Taufik Nurhidayat" />
				</div>
			</div>
			<div className="w-full lg:w-2/3 text-slate-700">
				...
				<div className="mt-8 flex gap-4 flex-wrap items-center text-sm">
					<a
						className="duration-300 inline-flex items-center px-4 py-3 rounded-lg bg-primary-500 text-white hover:shadow-lg hover:shadow-primary-600/50 hover:bg-primary-600"
